...
ADDONS_SRC+=" collada? ( ${ADDONS_URI}/4b87018f7fff1d054939d19920b751a0-collada2gltf-master-cb1d97788a.tar.bz2 ${ADDONS_URI}/OpenCOLLADA-master-6509aa13af.tar.bz2 )"
SRC_URI+=" ${ADDONS_SRC}"
